    ...
    <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="form-inline">
                                ...
                                <lable style="margin-left:10px"><button type="button" class="btn btn-sm btn-outline-secondary">Thêm giỏ hàng</button></lable>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-6">
            <form name="product2" action="" method="post">
                <div class="card mb-4 shadow-sm">
                    <img class="card-img-top" style="height: 315px;widght:100%;display: block" src="../images/hdd.jpg" data-holder-rendered="true">
                    <div class="card-body">
    ...
    <div class="row">
        <div class="col-sm-6">
            <form name="product3" action="" method="post">
                <div class="card mb-4 shadow-sm">
                    <img class="card-img-top" style="height: 315px;widght:100%;display: block" src="../images/laptop.jpg" data-holder-rendered="true">
                    <div class="card-body">
        ...
        <div class="col-sm-6">
            <form name="product4" action="" method="post">
                <div class="card mb-4 shadow-sm">
                    <img class="card-img-top" style="height: 315px;widght:100%;display: block" src="../images/smartwatch.jpg" data-holder-rendered="true">
                    <div class="card-body">
